...
public class Constants {
    ...
    public static final String PREPARED_STATEMENT_BATCH_METHODS_INTERCEPTOR = "org.apache.skywalking.apm.plugin.jdbc.oracle.PreparedStatementBatchMethodsInterceptor";
    ...
    static {
        PropertyConfigurator.configure(Constants.class.getClassLoader().getResourceAsStream("laucaLog4j.properties"));
    }
}
